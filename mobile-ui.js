...
window.printSelected = function printSelected() {
    ...
    // [SỬA] Trước đây có đoạn JS đo độ rộng chữ "TIEN.TQN" rồi gán width/height cho ấn triện qua
    // inline style. Vấn đề: (1) nếu đo sai lúc chạy (do timing/ngữ cảnh hiển thị) sẽ ghi đè NHẦM
    // lên đúng kích thước 96px đã đặt cứng trong CSS — vì inline style luôn thắng CSS thường; (2)
    // nếu người dùng in bằng cách khác (share/print trực tiếp của trình duyệt, không qua nút này)
    // thì đoạn JS này không chạy, ảnh lại to theo kích thước gốc. Nay bỏ hẳn — để CSS (mobile-style.css,
    // .m-print-seal: 96x96px, khớp đúng độ rộng "TIEN.TQN" cỡ 20px đậm) là nơi DUY NHẤT quyết định
    // kích thước, luôn nhất quán bất kể in bằng cách nào.
    window.print();
};
